...
public class State implements Cloneable {
	...
	public String toString() {
		...
		for (int col = 0; col < SIZE; col++) {
			...
			if (col > 0) buf.append(String.format("-+-+-\n", a, b, c));
	...
	public List<Move> getMoves() {
		return IntStream.range(0, LENGTH)
			...
			.filter(m -> this.board[m.index] == Color.NONE)
			.toList();
	}
	...
	public Color winner() {
		if (this.a3 > 0) return Color.BLACK;
		if (this.b3 > 0) return Color.WHITE;
		return Color.NONE;
	}
